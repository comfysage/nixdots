...
#     Type = "simple";
#     User = "root";
#     ExecStart = ''/home/comfy/.hayashi/pack/bin/vtcol colors set --file /home/comfy/.vtcol/${config.tty-colorscheme}'';
#   };
# };
{
  config,
...
in {
  ...
  options = {
    services.vtcol = {
      enable = mkEnableOption "vtcol tty colorscheme";
  ...
  config = mkIf cfg.enable (mkMerge [
    {
      assertions = [
        (hm.assertions.assertPlatform "services.vtcol" pkgs platforms.linux)
      ];
      ...
      systemd.user.services.vtcol = {
        ...
        Service = {
          Type = "simple";
          ExecStart = "/home/comfy/.hayashi/pack/bin/vtcol colors set --file /home/comfy/.vtcol/${cfg.settings.colorscheme}";
